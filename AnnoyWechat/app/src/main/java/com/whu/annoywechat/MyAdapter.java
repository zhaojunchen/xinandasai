        ...
        holder.row_isDec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (holder.row_isDec.isChecked() == true) {
                    /** 获取全局context*/
                    makeText(MyApplication.getContext(), "取消勾选:" + String.valueOf(holder.row_isDec.isChecked()), Toast.LENGTH_LONG).show();

                } else {

                    makeText(MyApplication.getContext(), "此时的ID是" + String.valueOf(holder.row_id), Toast.LENGTH_LONG).show();
                    makeText(MyApplication.getContext(), "勾选:" + String.valueOf(holder.row_isDec.isChecked() + "此时的ID是" + String.valueOf(holder.row_id.getText())), Toast.LENGTH_LONG).show();
                }
